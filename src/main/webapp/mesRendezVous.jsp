...
<head>
<meta charset="UTF-8">
<title>Insert title he<!DOCTYPE html>
<html lang="fr">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Espace CLIENT - Rendez-vous</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body class="bg-gray-100 p-6">
    <div class="max-w-4xl mx-auto bg-white shadow-md rounded-lg p-6">
        <h2 class="text-2xl font-semibold text-gray-700 mb-4">Mon Rendez-vous</h2>
        ...
        <table class="w-full border-collapse border border-gray-300">
            ...
            <tbody>
                ...
                <tr class="text-center">
                    ...
                    <td class="border border-gray-300 p-2">
                        <a href="Mdfclient.jsp" class="bg-blue-500 text-white px-3 py-1 rounded-md">Modifier</a>
                        <button class="bg-red-500 text-white px-3 py-1 rounded-md ml-2">Annuler</button>
                    </td>
                </tr>
            </tbody>
